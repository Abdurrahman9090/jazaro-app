...
import { Eye, EyeOff, Mail, Lock, User, Phone, Briefcase, MapPin, Award, ArrowLeft } from "lucide-react"
...
export default function FixerRegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#E0F7FA] via-[#B2EBF2] to-[#80DEEA] flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-2xl bg-white/95 backdrop-blur-[10px] border border-[#00BCD4]/30 shadow-[0_8px_32px_rgba(0,188,212,0.3)] rounded-[20px]">
        <CardHeader className="space-y-1">
          <div className="flex items-center justify-between">
            <Link href="/profile" className="text-[#006064] hover:text-[#00838F] transition-colors">
              <ArrowLeft className="h-5 w-5" />
            </Link>
            <CardTitle className="text-2xl font-bold text-[#00838F]">Become a Fixer</CardTitle>
            <div className="w-5" /> {/* Spacer for alignment */}
          </div>
          <CardDescription className="text-[#00838F]/80">
            Join Jazaro as a professional fixer
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          {step === 1 ? (
            <form onSubmit={handleNext} className="space-y-4">
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-[#00838F]">Personal Information</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="location" className="text-[#006064]">Location</Label>
                    <div className="relative">
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-[#00838F]">Professional Information</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="profession" className="text-[#006064]">Main Profession</Label>
                    <div className="relative">
                      ...
                      <Input
                        ...
                        name="profession"
                        type="text"
                        placeholder="Enter your main profession"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="experience" className="text-[#006064]">Years of Experience</Label>
                    <Select
                ...
                <div className="space-y-2">
                  <Label htmlFor="bio" className="text-[#006064]">Professional Bio</Label>
                  <Textarea
                    id="bio"
                    name="bio"
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-[#00838F]">Account Security</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
              ...
              >
                Next: Specialties & Certifications
              </Button>
            </form>
          ) : (
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-2">
                  {formData.certifications.map((cert, index) => (
                    <div key={index} className="flex items-center justify-between bg-white/80 p-2 rounded-lg">
