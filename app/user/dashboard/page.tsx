...
import { Input, Card, Typography, Modal, Button } from "antd";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#E0F7FA] via-[#B2EBF2] to-[#80DEEA] max-w-md mx-auto relative overflow-hidden">
      ...
      <div className="relative z-10 px-4 py-3 bg-white/50 backdrop-blur-[10px]">
        <Input
          prefix={<SearchOutlined className="text-[#00838F]" />}
          placeholder="Search for fixers or services..."
          className="bg-white/80 backdrop-blur-[10px] border border-[#00BCD4]/30 text-[#006064] placeholder:text-[#00838F] focus:border-[#00BCD4] focus:ring-[#00BCD4]/20 rounded-[10px] pl-2"
      ...
      <div className="relative z-10 flex-1 px-4 py-4 bg-white/30 backdrop-blur-[10px]">
        <Card
          className="bg-white/60 backdrop-blur-[10px] rounded-[10px] h-96 relative overflow-hidden border border-[#00BCD4]/30 shadow-[0_4px_10px_rgba(0,188,212,0.3)]"
        ...
        >
          ...
          <Card
            className="absolute top-4 left-4 right-4 z-[1000] bg-white/90 backdrop-blur-[10px] rounded-[10px] p-3 border border-[#00BCD4]/30 shadow-[0_4px_10px_rgba(0,188,212,0.3)]"
            bodyStyle={{ padding: 12 }}
            bordered={true}
          >
            <Text className="text-sm text-[#006064] font-medium">
              📍 Interactive Map
            </Text>
            <br />
            <Text className="text-xs text-[#00838F]">
      ...
      {/* Stats Section */}
      <Card
        className="relative z-10 px-4 py-4 bg-white/60 backdrop-blur-[10px] border-t border-[#00BCD4]/20"
        bodyStyle={{ padding: 0 }}
        bordered={false}
      >
      ...
      {/* Camera Modal (replaced with antd Modal for demo) */}
      <Modal
        open={isCameraOpen}
        onCancel={() => setIsCameraOpen(false)}
        onOk={() => {
          handleCameraCapture("demo-image-data");
      ...
      >
        <div className="text-center">
          <p>Camera functionality goes here.</p>
          {/* You can integrate your camera logic here */}
        </div>
      </Modal>
