...
const recentActivities = [
  { type: "success", message: "New fixer John D. verified and approved", time: "2 min ago" },
  { type: "info", message: "Service request #SR-1234 completed successfully", time: "5 min ago" },
  { type: "warning", message: "AI detected washing machine issue with 95% confidence", time: "8 min ago" },
  { type: "error", message: "Payment dispute reported for service #SR-1230", time: "12 min ago" },
];
  ...
  return (
    <div style={{ padding: 16 }}>
      <div>
        ...
        <Text type="secondary">Monitor your Jazaro platform performance</Text>
      </div>
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                <div>
                  ...
                  <div style={{ display: "flex", alignItems: "center", marginTop: 8 }}>
                    <TrendingUp size={16} style={{ color: "#22c55e", marginRight: 4 }} />
                    <Text style={{ color: "#22c55e" }}>{stat.change} this month</Text>
                  </div>
                </div>
                <div
                  style={{
            ...
            <div style={{ maxHeight: 192, overflowY: "auto" }}>
              {recentActivities.map((activity, index) => (
                ...
                >
                  ...
                  <Text type="secondary" style={{ fontSize: 12, marginLeft: 8 }}>{activity.time}</Text>
                </div>
              ))}
            </div>
          </Card>
        ...
        <Col xs={24} lg={12}>
          <Card title="Platform Performance">
            <div style={{ marginBottom: 24 }}>
              ...
              <Progress percent={99.9} showInfo={false} strokeColor="#2563eb" />
            </div>
            <div style={{ marginBottom: 24 }}>
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
              ...
              <Progress percent={91.2} showInfo={false} strokeColor="#7c3aed" />
            </div>
            <div>
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 4 }}>
              ...
              <Progress percent={94.5} showInfo={false} strokeColor="#16a34a" />
            </div>
          </Card>
        </Col>
        <Col xs={24} lg={12}>
