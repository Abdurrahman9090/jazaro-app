...
function getStatusIcon(step: string, completed?: boolean, current?: boolean) {
  if (completed) return <CheckCircle className="w-6 h-6" color="#52c41a" />;
  if (current) {
    switch (step) {
                ...
                >
                  <Space align="center" size={16}>
                    <Avatar
                      ...
                      style={{
                        background:
                          "linear-gradient(to right, #1e40af, #6366f1)",
                        color: "#fff",
            ...
            <div style={{ position: "relative" }}>
              <div
                style={{
                  height: 288,
                  background:
                    "linear-gradient(135deg, #bae6fd 0%, #ede9fe 50%, #f5d0fe 100%)",
                  position: "relative",
                  overflow: "hidden",
                  boxShadow: "0 4px 24px #0001",
                }}
              >
                ...
                <div
                  style={{
                    ...
                    inset: 0,
                    background:
                      "linear-gradient(135deg, #bae6fdcc 0%, #bbf7d0cc 100%)",
